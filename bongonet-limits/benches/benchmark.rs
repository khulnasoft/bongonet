...
/*
Bongonet Estimator single thread 1.042849543s total, 10ns avg per operation
...
Bongonet Estimator thread#7 2.654667606s total, 212ns avg per operation
Bongonet Estimator thread#2 2.65651993s total, 212ns avg per operation
Bongonet Estimator thread#4 2.658225266s total, 212ns avg per operation
Bongonet Estimator thread#0 2.660603361s total, 212ns avg per operation
Bongonet Estimator thread#1 2.66139014s total, 212ns avg per operation
Bongonet Estimator thread#6 2.663498849s total, 213ns avg per operation
Bongonet Estimator thread#5 2.663344276s total, 213ns avg per operation
Bongonet Estimator thread#3 2.664652951s total, 213ns avg per operation
...
Bongonet Estimator single thread 1.066846098s total, 10ns avg per operation
...
fn main() {
    ...
    // single thread
    {
        ...
        let bongonet_est = Estimator::new(3, 1024);
        run_bench(&bongonet_est, SAMPLES, &distribution, "single thread");
    }
    ...
    // multithread
    let bongonet_est = Arc::new(Estimator::new(3, 1024));
    run_threaded_bench(THREADS, bongonet_est, SAMPLES_PER_THREAD, &distribution);
