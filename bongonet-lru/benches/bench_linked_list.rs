...
fn main() {
    ...
    let mut list = bongonet_lru::linked_list::LinkedList::with_capacity(ITEMS);
    let before = Instant::now();
    for _ in 0..ITEMS {
        list.push_head(0);
    }
    let elapsed = before.elapsed();
    println!(
        "bongonet linked list push_head total {elapsed:?}, {:?} avg per operation",
        elapsed / ITEMS as u32
    );
    ...
    let elapsed = before.elapsed();
    println!(
        "bongonet linked list iter total {count} {elapsed:?}, {:?} avg per operation",
        elapsed / count as u32
    );
    ...
    let elapsed = before.elapsed();
    println!(
        "bongonet linked search first 10 items total {elapsed:?}, {:?} avg per operation",
        elapsed / ITEMS as u32
    );
    ...
    let elapsed = before.elapsed();
    println!(
        "bongonet linked optimized search first 10 items total {elapsed:?}, {:?} avg per operation",
        elapsed / ITEMS as u32
    );
    ...
    let elapsed = before.elapsed();
    println!(
        "bongonet linked list move tail to head total {elapsed:?}, {:?} avg per operation",
        elapsed / ITEMS as u32
    );
    ...
    let elapsed = before.elapsed();
    println!(
        "bongonet linked list pop_tail total {elapsed:?}, {:?} avg per operation",
        elapsed / ITEMS as u32
    );
}
