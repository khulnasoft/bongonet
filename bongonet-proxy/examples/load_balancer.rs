...
use bongonet_load_balancing::{health_check, selection::RoundRobin, LoadBalancer};
...
impl ProxyHttp for LB {
    ...
    async fn upstream_request_filter(
        ...
        upstream_request: &mut bongonet_http::RequestHeader,
        _ctx: &mut Self::CTX,
    ) -> Result<()> {
        upstream_request
...
fn main() {
    ...
    let mut lb = bongonet_proxy::http_proxy_service(&my_server.configuration, LB(upstreams));
