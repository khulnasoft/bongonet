...
use bongonet_core::modules::http::HttpModules;
...
mod my_acl {
    use super::*;
    use bongonet_core::modules::http::{HttpModule, HttpModuleBuilder, Module};
    use bongonet_error::{Error, ErrorType::HTTPStatus};
    use std::any::Any;
...
fn main() {
    ...
    let mut my_proxy = bongonet_proxy::http_proxy_service(&my_server.configuration, MyProxy);
