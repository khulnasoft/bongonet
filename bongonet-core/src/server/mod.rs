...
/// The server object
///
/// This object represents an entire bongonet server process which may have multiple independent
...
// NOTE: we need to keep the runtime outside async since
    ...
    ///
    /// This method is intended for bongonet frontends that are NOT using the built-in
