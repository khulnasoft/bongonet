...
///
/// Bongonet configuration files are by default YAML files, but any key value format can potentially
/// be used.
///
/// # Extension
...
impl Default for ServerConf {
    fn default() -> Self {
        ServerConf {
            ...
            pid_file: "/tmp/bongonet.pid".to_string(),
            upgrade_sock: "/tmp/bongonet_upgrade.sock".to_string(),
            user: None,
            group: None,
            threads: 1,
            work_stealing: true,
...
pub struct Opt {
    ...
    #[clap(
        short,
        long,
        help = "This is the base set of command line arguments for a bongonet-based service",
        long_help = None
    )]
    pub upgrade: bool,
