...
//! `bongonet-ketama/examples/health_aware_selector.rs`.
//!
//! For a carefully crafted real-world example, see the [`bongonet-load-balancing`](https://docs.rs/bongonet-load-balancing)
//! crate.
...
mod tests {
    ...
    fn matches_nginx_sample() {
        ...
        assert_eq!(
            c.node(b"/bongonet/team/is/cool/and/this/is/a/long/uri"),
            Some(get_sockaddr("127.0.0.1:7778"))
        );
        assert_eq!(
